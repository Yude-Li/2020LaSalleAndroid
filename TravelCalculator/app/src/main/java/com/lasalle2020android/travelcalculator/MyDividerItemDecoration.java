...
public class MyDividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public MyDividerItemDecoration(Context context, Drawable divider) {
        mDivider = divider;
    ...
    private void drawVerticalDividers(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount - 1; i++) {
            ...
            mDivider.setBounds(parentLeft + dpToPx(margin), parentTop, parentRight - dpToPx(margin), parentBottom);
